                ...
                <div className="flex flex-col gap-2 mb-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="relative" ref={filterRef}>
                            <button
                                ...
                                className={`
                        border text-xs font-bold px-3 py-2 rounded-lg flex items-center gap-2 transition-all select-none
                    ...
                    `}
                        ...
                        <button
                            ...
                            className={`border text-xs font-bold px-3 py-2 rounded-lg flex items-center gap-2 transition-all select-none ${isSelecting
                                    ? 'bg-zinc-900 dark:bg-white text-white dark:text-black border-transparent'
                                    : 'bg-zinc-100 dark:bg-[#121214] hover:bg-zinc-200 dark:hover:bg-white/5 border-zinc-200 dark:border-white/10 text-zinc-700 dark:text-white'
                                }`}
                        >
                    ...
                    {isSelecting && (
                        <div className="flex items-center justify-between gap-2 rounded-xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-white/5 px-3 py-2">
        ...
        >
            ...
            <div className="relative w-11 h-11 flex-shrink-0 self-start rounded-md bg-zinc-200 dark:bg-zinc-800 overflow-hidden group/image">
                ...
                {song.isGenerating ? (
                    <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center gap-0.5">
                        {song.queuePosition ? (
                            ...
                            <>
                                ...
                                <span className="text-[8px] font-medium text-amber-400">#{song.queuePosition}</span>
                            </>
                        ) : (
                    ...
                    >
                        <div className="w-7 h-7 rounded-full bg-white flex items-center justify-center shadow-lg transform transition-transform hover:scale-105">
                            {isCurrent && isPlaying ? (
                                <Pause fill="black" className="text-black w-3.5 h-3.5" />
                            ) : (
                                <Play fill="black" className="text-black ml-0.5 w-3.5 h-3.5" />
                            )}
                        </div>
                    </div>
                )}
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-between">
                <div className="space-y-0">
                    <div className="flex items-center gap-2">
                        {isEditingTitle && isOwner ? (
                            <input
                                ...
                                className="font-medium text-xs bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded border border-pink-500 focus:outline-none text-zinc-900 dark:text-white min-w-0 flex-1"
                            />
                        ) : (
                            <h3
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <div className="w-3 h-3 rounded-full bg-purple-500 text-[7px] flex items-center justify-center font-bold text-white">
                                {(song.creator?.[0] || 'U').toUpperCase()}
                            </div>
                            <span className="text-[10px] text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200 transition-colors hover:underline">
                                {song.creator || 'Unknown'}
                            </span>
                        </div>
                    </div>
                    <p className="text-[10px] text-zinc-500 dark:text-zinc-500 line-clamp-1 font-medium max-w-2xl">
                        {song.style}
                    </p>
                    {song.isGenerating && (
                        <div className="pt-1">
                            <div className="h-0.5 rounded-full bg-zinc-200/70 dark:bg-white/10 overflow-hidden">
                                <div
                ...
                {!song.isGenerating && (
                    <div className="flex items-center gap-0.5 pt-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        >
                            ...
                            {(song.likeCount || 0) > 0 && (
                                <span className="text-[10px] font-bold">{song.likeCount}</span>
                            )}
                        </button>

                        <button
                            className="p-1.5 rounded-full hover:bg-zinc-200 dark:hover:bg-white/5 text-zinc-400 hover:text-black dark:hover:text-white transition-colors"
                            onClick={(e) => { e.stopPropagation(); }}
                        >
                            <ThumbsDown size={14} />
                        </button>
                        ...
                        <button
                            className="p-1.5 rounded-full hover:bg-zinc-200 dark:hover:bg-white/5 text-zinc-400 hover:text-black dark:hover:text-white transition-colors ml-auto"
                        ...
                        <button
                            className="p-1.5 rounded-full hover:bg-zinc-200 dark:hover:bg-white/5 text-zinc-400 hover:text-black dark:hover:text-white transition-colors xl:hidden"
            ...
            {/* Timestamp */}
            <div className="text-[10px] font-mono text-zinc-500 dark:text-zinc-600 self-center">
                {song.isGenerating ? (
